...
/**
 * Template Name: user_dashboard_bk191123
 */
...
if (cookieValue !== "") {
    ...
    // Do something with the cookie value here
         ...
         var headurl='http://192.168.1.2:3000/';

    jQuery(document).ready(function($) {
    // $('#form-login').submit(function(e) {
    //     e.preventDefault();
               
                 var token_verify ='http://192.168.1.2:3000/verify_token';
        ...
        var headers = {
            ...
            $.ajax({
              url: headurl + 'verify_token', // Replace with your API URL
              type: 'GET',
              headers: headers,
              dataType: 'json',
...
// });
        ...
        $('.delete-btn').on('click', function() {
            var itemId = $(this).data('id');
            var user_delete ='http://192.168.1.2:3000/delete_userdata';
            // Implement the delete logic using the API
            if (confirm('Are you sure you want to delete this item?')) {
                $.ajax({
                    url: user_delete + '/' + itemId,
                    method: 'DELETE',
                    success: function() {
...
/**
 * Template Name: user_dashboard_org_bk191023
 */
